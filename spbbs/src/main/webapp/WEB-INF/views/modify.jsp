...
<div class="container">
	<form class="row was-validated" name="modify_form" action="modifyok" method="post">
		<div class="col-md-6">
			<label>이름</label>
			<input type="text" name="uname" class="form-control" placeholder="이름" required value="${modify.uname }" readonly/>
			<div class="invalid-feedback">이름을 입력하세요.</div>
		</div>
		<div class="col-md-6">
			<label>비밀번호</label>
			<input type="password" name="upass" class="form-control" placeholder="비밀번호" required value="${modify.upass }" readonly/>
			<div class="invalid-feedback">비밀번호를 입력하세요.</div>
		</div>
		<div class="col-md-12">
			<label>제목</label>
			<input type="text" name="title" class="form-control" placeholder="제목" required value="${modify.title }"/>
